...
class UserController {
  async registration(req, res, next) {
    ...
    if(phoneCheck){
      return next(ApiError.badRequest("Пользователь с таким телефоном уже зарегистрирован"))
    }
    ...
    const user = await User.create({name, surname, patronymic, phone, email, password: hashPassword, roleId});
